...
class Vocher(models.Model):
    ...
    product=models.ManyToManyField(to='shop.Item',blank=True,related_name='voucher')
...
class Shop_program(models.Model):
    ...
    product=models.ManyToManyField(to='shop.Item',blank=True,related_name='shop_program')
    valid_from=models.DateTimeField()
    valid_to=models.DateTimeField()
    created=models.DateTimeField(auto_now=True)
...
class Promotion_combo(models.Model):
    ...
    product=models.ManyToManyField(to='shop.Item',blank=True,related_name='promotion_combo')
    valid_from=models.DateTimeField()
    valid_to=models.DateTimeField()
...
class Flash_sale(models.Model):
    shop=models.ForeignKey(to='shop.Shop',on_delete=models.CASCADE)
    product=models.ManyToManyField(to='shop.Item',blank=True,related_name='flash_sale')
    valid_from=models.DateTimeField()
    valid_to=models.DateTimeField()
    created=models.DateTimeField(auto_now=True)
