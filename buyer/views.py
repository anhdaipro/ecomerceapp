...
class HomeAPIView(APIView):
    ...
    def get(self,request):
        ...
        data={
            ...
            'percent_discount':i.discount_flash_sale(),'item_id':i.id,'total_inventory':i.total_inventory(),'max_price':i.max_price(),'item_url':i.get_absolute_url(),
    ...
    def post(self, request, *args, **kwargs):
        ...
        for product in list_product_cart:
            ...
            if byproduct_cart.exists():
                ...
                byproduct_create.append(Byproduct(user=user,cartitem=cartitem,item_id=item_id,product_id=product['product_id'],quantity=product['quantity'])
            )
