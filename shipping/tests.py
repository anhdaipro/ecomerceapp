...
const Login = ({ login, isAuthenticated }) => {
    ...
    export function googleLogin(accessToken) {
        axios.post(`https://anhdai.herokuapp.com//api-auth/convert-token`, {
            ...
            client_id: "487987454497-pgoqpfq7s8tp7icr8c3c7pqm7mvmulbp.apps.googleusercontent.com",
            client_secret: "ev9_gghaFDWSRrvXNE8hGYea",
          })
          .then((res) => {
                    ...
                    <div className="_3KEKx7 _34gSQ- _2kpMlA">
                        <div className="Xqnqjs">
                            <div className="_3-m13F">
                                ...
                                <div className="_2FAubX">
                                    ...
                                    <a className="YKCgqk" href="/buyer/login/qr">
                        ...
                        <div className="_3e4zDA">
                            ...
                            <div className="_35M4-Y">
                                <div className="_3mizNj">
                                    <input required onChange={e => onChange(e)} value={formData.password} className="yReWDs" type={state.showrepass?'text':'password'} placeholder="Mật khẩu" autoComplete="current-password" name="password" maxLength="16"/>
                                    <button onClick={(e)=>showpass(e,'showrepass',state.showrepass)} className="_1mrJbr" >
                                        {!state.showrepass?
                            ...
                            <div className="_1upyIZ">
                                <a className="_2Sf-pK" href="/buyer/reset">Quên mật khẩu</a>
                                <a className="_2Sf-pK" href="/buyer/login/otp?next=https%3A%2F%2Fshopee.vn%2F10-h%25E1%25BB%2599p-adidas-35x24x12-i.95696640.7106363761%3Fsp_atk%3D59c4bf07-a0f2-4f3b-852c-847e6346941c">Đăng nhập với SMS</a>
                            </div>
                            <div>
                                ...
                                <div className="_1ix216">
                                    <button className="_1hKScg _2Ct2Hr _39svdr _2P7qLN">
                                        <div className="BnBJFp">
                                            <div onClick={continueWithFacebook} className="_30SGUu social-white-background social-white-fb-png"></div>
                                        </div>
                                        <div className="_1DQYn2">Facebook</div>
                                    </button>
                                    <button onClick={continueWithGoogle} className="_1hKScg _2Ct2Hr _1rblAp _2P7qLN">
                                    ...
                                    <button onClick={continueWithFacebook} className="_1hKScg _2Ct2Hr _19QKb7 _2P7qLN">
                                        <div className="BnBJFp">
