...
class VoucherSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        extra_kwargs = {'name_of_the_discount_program': {'write_only': True}}
...
class ProgramSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Shop_program
        fields = ['name_program','valid_from','valid_to','list_product']
...
class DealsockSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['shock_deal_type','program_name_buy_with_shock_deal','valid_from','valid_to',
...
class FlashsaleSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Flash_sale
        fields = ['valid_from','valid_to','list_product']
